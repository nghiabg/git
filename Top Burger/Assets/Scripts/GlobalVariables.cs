    ...
    public void ChangeStarsOnWorld(int numberOfWorldSelected, int newStars)
    {
        switch (numberOfWorldSelected)
        {
            case 1:
                ...
                if (currentLevel == 60)
                {
                    GameObject.Find("WinMenu").transform.Find("AnimationHolder/WinHolder/AnimationHolder/ButtonsHolder/ButtonNext").gameObject.SetActive(false);
                    GameObject.Find("WinMenu").transform.Find("AnimationHolder/WinHolder/AnimationHolder/ButtonsHolder/ButtonRestartBG").gameObject.SetActive(false);
                    GameObject.Find("WinMenu").transform.Find("AnimationHolder/WinHolder/AnimationHolder/ButtonsHolder/ButtonRestart").localPosition = new Vector3(208, -2.6f, 0);
