	...
	void SetTimerText()
	{
		...
		if (seconds < 1 && minutes < 1) 
		{
			...
			else if(GlobalVariables.GameplayMode==2)
			{
				...
				GameObject.Find("Canvas").GetComponent<MenuManager>().ShowMenu(GameObject.Find("Canvas/PopUps").transform.Find("TimeAttackEndMenu").gameObject);
...
//		if(LevelGenerator.score>=20)
		if(LevelGenerator.score>=LevelsParser.ListOfLevels[GlobalVariables.currentLevel-1].levelGoal)
		{
			...
			GameObject.Find("Canvas").GetComponent<MenuManager>().ShowMenu(GameObject.Find("Canvas/PopUps").transform.Find("WinMenu").gameObject);
		...
		else
		{
			...
			GameObject.Find("Canvas").GetComponent<MenuManager>().ShowMenu(GameObject.Find("Canvas/PopUps").transform.Find("LoseMenu").gameObject);
...
//			StartCoroutine(GlobalVariables.Instance.moneyCounter(-500, GameObject.Find("CoinsText").GetComponent<Text>()));
	...
	{
		GameObject.Find("HeadBG").transform.Find("ParticlesHolder").GetChild(0).gameObject.SetActive(true);
		GameObject.Find("HeadBG").transform.Find("ParticlesHolder").GetChild(1).gameObject.SetActive(true);
	}
	...
	public void PauseGame()
	{
		...
		if(GlobalVariables.GameplayMode!=0)
		{
			...
			if(LevelGenerator.isMadCustomer)
			{
				GameObject.Find("HeadBG").transform.Find("ParticlesHolder").GetChild(0).gameObject.SetActive(false);
				GameObject.Find("HeadBG").transform.Find("ParticlesHolder").GetChild(1).gameObject.SetActive(false);
			}
			GameObject.Find("ClockHolder").GetComponent<Animator>().speed = 0;
			SoundManager.Instance.Pause_TimeCountDown();
		}
