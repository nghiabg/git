...
public class LevelGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        titleUnlock = GameObject.Find("Canvas").transform.Find("PopUps/PopUpUnlocked/AnimationHolder/Body/HeaderHolder/TextHeader").GetComponent<Text>();
        messageUnlock = GameObject.Find("Canvas").transform.Find("PopUps/PopUpUnlocked/AnimationHolder/Body/ContentHolder/TextBG/TextMessage").GetComponent<Text>();
        imageUnlock = GameObject.Find("Canvas").transform.Find("PopUps/PopUpUnlocked/AnimationHolder/Body/ContentHolder/ItemBG/Item").GetComponent<Image>();
        SetGoalPopUp();
        ...
        {
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(0).GetChild(0).GetComponent<Image>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(0).GetChild(2).GetComponent<Text>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(0).GetChild(3).gameObject.SetActive(false);
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(0).GetChild(0).GetComponent<Button>().interactable = true;
        ...
        {
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(1).GetChild(0).GetComponent<Image>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(1).GetChild(2).GetComponent<Text>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(1).GetChild(3).gameObject.SetActive(false);
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(1).GetChild(0).GetComponent<Button>().interactable = true;
        ...
        {
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(2).GetChild(0).GetComponent<Image>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(2).GetChild(2).GetComponent<Text>().color = Color.white;
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(2).GetChild(3).gameObject.SetActive(false);
            GameObject.Find("PopUps/PopUpGoal/AnimationHolder/Body/ContentHolder").transform.Find("PowerslHolder").transform.GetChild(2).GetChild(0).GetComponent<Button>().interactable = true;
    ...
    {
        if (winGame)
            GameObject.Find("WinHolder").transform.Find("AnimationHolder/SparklesMain").gameObject.SetActive(false);
        score = 0;
        winGame = false;
        ...
        GameObject.Find("HeadBG").transform.Find("ParticlesHolder/SmokeParticleRight").gameObject.SetActive(false);
        GameObject.Find("HeadBG").transform.Find("ParticlesHolder/SmokeParticleLeft").gameObject.SetActive(false);
        if (GlobalVariables.GameplayMode != 0)
        {
            GameObject.Find("ClockHolder").transform.Find("AnimationHolder/SmokeHolder/SmokeParticleMidle").gameObject.SetActive(false);
        }
        for (int i = 0; i < 14; i++)
        {
        ...
        LevelGenerator.gameActive = false;
        isMadCustomer = false;
        GameObject.Find("Canvas").GetComponent<MenuManager>().ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("LoadingHolder").gameObject);
        GameObject.Find("Canvas/PopUps").transform.Find("LoadingHolder/LoadingHolder/AnimationHolder").GetComponent<Animator>().Play("LoadingGameplayArriving");
    }
    ...
    public void SubmitMeal()
    {
        ...
        if (championshipallMealsOrder.Count > 0)
        {
            ...
            {
                GameObject.Find("Canvas/PopUps").transform.Find("ChefChampionshipMenu/AnimationHolder/WatchVideoHolder").gameObject.SetActive(true);
            }
            else
            {
                GameObject.Find("Canvas/PopUps").transform.Find("ChefChampionshipMenu/AnimationHolder/WaitingForJudgesHolder").gameObject.SetActive(true);
                StartCoroutine("WaitForJudges");
            }
            GameObject.Find("Canvas").GetComponent<MenuManager>().ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("ChefChampionshipMenu").gameObject);
    ...
    IEnumerator WaitForJudges()
    {
        ...
        GameObject.Find("Canvas/PopUps").transform.Find("ChefChampionshipMenu/AnimationHolder/WaitingForJudgesHolder").GetComponent<Animator>().Play("WaitingForJudgesArriving");
        yield return new WaitForSeconds(5f);
        GameObject.Find("Canvas/PopUps").transform.Find("ChefChampionshipMenu/AnimationHolder/WaitingForJudgesHolder").GetComponent<Animator>().Play("WaitingForJudgesDeparting");
