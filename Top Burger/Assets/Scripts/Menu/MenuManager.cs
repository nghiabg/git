...
public class MenuManager : MonoBehaviour
{
    ...
    //Khoảng cách giữa điểm đầu chạm và điểm sau
    public float minSwipedistX;
    public float minSwipedistY;

    //tọa độ chạm đầu tiên
    ...
    void Start()
    {
        ...
        if (Application.loadedLevelName == "MainScene")
        {
            ...
            {
                GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/WorldsHolder/World3").Find("Locked").gameObject.SetActive(false);
                GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/WorldsHolder/World2").Find("Locked").gameObject.SetActive(false);
            }
        ...
        if (Input.GetKeyUp(KeyCode.Escape) && canEscape)
        {
            if (Application.loadedLevelName.Equals("MainScene"))
            {
                ...
                if (popupType == 2)
                {
                    ...
                    ClosePopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("ShopHolder").gameObject);
                    //					ShowInterstitial(1);
                ...
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpCrossPromotionOfferWall").gameObject);
                    popupType = 1;
                }
                else if (popupType == 4)
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpSettings").gameObject);
                    popupType = 1;
                }
                else if (popupType == 5)
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpInterstitial").gameObject);
                    popupType = 1;
                }
                else if (popupType == 6)
                {
                    StartCoroutine(ChangeEscapeBool(1.5f));
                    ClosePopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("WorldChooserMenu").gameObject);
                ...
                else if (popupType == 7)
                {
                    ...
                    ClosePopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("LevelChooserMenu").gameObject);
                    popupType = 6;
                }
                else if (popupType == 8)
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpDoubleCoins").gameObject);
                    popupType = 1;
                }
                else if (popupType == 9)
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpRate").gameObject);
                    popupType = 1;
                }
                else if (popupType == 10)
                {
                    StartCoroutine(ChangeEscapeBool(1));
                    ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpMessage").gameObject);
                    popupType = 2;
                }
            }
            else if (Application.loadedLevelName.Equals("GamePlay"))
            {
                if (GlobalVariables.GameplayMode == 0)
                {
                    if (popupType == 1)
                    {
                        ...
                        ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpPause").gameObject);
                    ...
                    else if (popupType == 2)
                    {
                        StartCoroutine(ChangeEscapeBool(1.5f));
                        popupType = 1;
                        ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpPause").gameObject);

                    }
                    else if (popupType == 3)
                    {
                        StartCoroutine(ChangeEscapeBool(1.5f));
                        ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("ShopHolder").gameObject);
                        popupType = 1;
                    }
                    else if (popupType == 4)
                    {
        ...
        if (Input.touchCount > 0)
        {
            ...
            switch (touch.phase)
            {
                ...
                case TouchPhase.Ended:
                    ...
                    // Nếu đủ thì kiểm tra xem đang vuốt theo hướng nào
                    if (swipeDistHorizontal > minSwipedistX)
                    {
                        float swipeValues = Mathf.Sign(touch.position.x - startPos.x);
                        if (swipeValues > 0)
    ...
    void ShowSpecialOffer()
    {
        ...
        ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpDoubleCoins").gameObject);
    }
    ...
    public void MoveLeftWorld()
    {
        ...
        {
            case 0:
                GlobalVariables.numberOfWorldSelected = 3;
            ...
            case 3:
                ...
                GameObject.Find("WorldsHolder").GetComponent<Animator>().Play("WorldsMove4");
                break;
            default:
    ...
    public void MoveRightWorld()
    {
        switch (GlobalVariables.numberOfWorldSelected)
        {
            ...
            case 1:
                GlobalVariables.numberOfWorldSelected = 3;
                GameObject.Find("WorldsHolder").GetComponent<Animator>().Play("WorldsMove4Reverse");
                break;
            case 2:
                GlobalVariables.numberOfWorldSelected = 1;
    ...
    public void StartModeOrLevelSelector()
    {
        switch (GlobalVariables.GameplayMode)
        {
            case 0:
                ...
                switch (GlobalVariables.numberOfWorldSelected)
                {
                    case 0:
                        if (GlobalVariables.numberOfWorldUnlocked == 3)
                        {
                            ...
                            ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("LoadingMenu").gameObject);
                        }
                        else
                        {
                ...
                break;
            case 1:
                GameObject.Find("Canvas").transform.Find("Menus/LevelChooserMenu/LevelsChooseHolder/AnimationHolder/HeaderHolder/CoinHolderlHolder/CoinlLevelsChooserText").GetComponent<Text>().text = GlobalVariables.coins.ToString();
                ...
                switch (GlobalVariables.numberOfWorldSelected)
                {
                    case 0:
                        if (GlobalVariables.numberOfWorldUnlocked == 3)
                        {
                            GameObject.Find("Menus").transform.Find("LevelChooserMenu/LevelsChooseHolder/AnimationHolder/LevelChooseText").GetComponent<Text>().text = "WORLD 3";
                            ShowPopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("LevelChooserMenu").gameObject);
                    ...
                    case 1:
                        ShowPopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("LevelChooserMenu").gameObject);
                        GameObject.Find("Menus").transform.Find("LevelChooserMenu/LevelsChooseHolder/AnimationHolder/LevelChooseText").GetComponent<Text>().text = "WORLD 1";
                        PrepareLevels();
                        break;
                    case 2:
                        if (GlobalVariables.numberOfWorldUnlocked >= 2)
                        {
                            GameObject.Find("Menus").transform.Find("LevelChooserMenu/LevelsChooseHolder/AnimationHolder/LevelChooseText").GetComponent<Text>().text = "WORLD 2";
                            ShowPopUpMenu(GameObject.Find("Canvas/Menus").transform.Find("LevelChooserMenu").gameObject);
                            PrepareLevels();
                        }
                        else
                ...
                switch (GlobalVariables.numberOfWorldSelected)
                {
                    case 0:
                        if (GlobalVariables.numberOfWorldUnlocked == 3)
                        {
                            ...
                            ShowMenu(GameObject.Find("Canvas/PopUps").transform.Find("LoadingMenu").gameObject);
        ...
        switch (GlobalVariables.numberOfWorldSelected)
        {
            case 0:
                for (int i = 0; i < 60; i++)
                {
                    ...
                    Levels.transform.GetChild(i).GetChild(1).Find("StarsHolder").GetChild(0).gameObject.SetActive(false);
                    Levels.transform.GetChild(i).GetChild(1).Find("StarsHolder").GetChild(1).gameObject.SetActive(false);
                    Levels.transform.GetChild(i).GetChild(1).Find("StarsHolder").GetChild(2).gameObject.SetActive(false);
                    ...
                    if (GlobalVariables.Instance.world3Stars[i] != "-1")
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Levels.transform.GetChild(i).GetChild(1).Find("StarsHolder").GetChild(k).gameObject.SetActive(true);
                            }
                        }
                    }
                    else
            ...
            case 1:
                for (int i = 0; i < 60; i++)
                {
                    ...
                    Levels.transform.GetChild(i).Find("Unlocked/StarsHolder").GetChild(0).gameObject.SetActive(false);
                    Levels.transform.GetChild(i).Find("Unlocked/StarsHolder").GetChild(1).gameObject.SetActive(false);
                    Levels.transform.GetChild(i).Find("Unlocked/StarsHolder").GetChild(2).gameObject.SetActive(false);
                    ...
                    if (GlobalVariables.Instance.world1Stars[i] != "-1")
                    {
                        ...
                        else
                        {
                            Levels.transform.GetChild(i).GetChild(1).gameObject.SetActive(true);
                            Levels.transform.GetChild(i).GetChild(2).gameObject.SetActive(false);
                            Levels.transform.GetChild(i).Find("Unlocked").GetComponent<Animator>().Play("New State");
                            string number = GlobalVariables.Instance.world1Stars[i];

                            for (int k = 0; k < int.Parse(number); k++)
                            {
                                Levels.transform.GetChild(i).Find("Unlocked").Find("StarsHolder").GetChild(k).gameObject.SetActive(true);
                            }
                        }
                    }
                    else
    ...
    public void LoadNextLevel()
    {
        ...
        GameObject.Find("Canvas/PopUps").transform.Find("LoadingHolder").gameObject.SetActive(true);
        GameObject.Find("Canvas/PopUps").transform.Find("LoadingHolder/LoadingHolder/AnimationHolder").GetComponent<Animator>().Play("LoadingGameplayDeparting");
        ShowMenu(GameObject.Find("Canvas/PopUps").transform.Find("LoadingHolder").gameObject);
    }
    ...
    public void StartWorldChooser()
    {
        ...
        {
            GameObject.Find("Canvas/Menus").transform.Find("MainMenu").GetComponent<Animator>().Play("Departing");
            GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/HeaderHolder/CoinHolderlHolder/CoinlWorldChooserText").GetComponent<Text>().text = GlobalVariables.coins.ToString();
        }
        else
        {
    ...
    {
        ClosePopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpUnlocked").gameObject);
        yield return new WaitForSeconds(0.75f);
        ShowPopUpMenu(GameObject.Find("Canvas/PopUps").transform.Find("PopUpGoal").gameObject);
    }
    ...
    public void RefreshCoins()
    {
        ...
        {
            GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/HeaderHolder/CoinHolderlHolder/CoinlWorldChooserText").GetComponent<Text>().text = GlobalVariables.coins.ToString();
            GameObject.Find("Canvas").transform.Find("Menus/LevelChooserMenu/WorldChooseHolder/AnimationHolder/HeaderHolder/CoinHolderlHolder/CoinlLevelsChooserText").GetComponent<Text>().text = GlobalVariables.coins.ToString();
        }
        else
        {
    ...
    {
        GameObject.Find("ShopPartHolder/BGShopContent").transform.Find("RemoveAdsButton/RemoveAdsButton/Body").GetComponent<Image>().color = Siva;
        GameObject.Find("ShopPartHolder/BGShopContent").transform.Find("RemoveAdsButton/RemoveAdsButton/Icon").GetComponent<Image>().color = Siva;
