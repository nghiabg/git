...
//				else
				{
					GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/ModeHolder/DeselectedHolder/ChefDeselected/ChefBlue/Available/ButtonSpeedUp").gameObject.SetActive(true);
				}
			}
...
//					GameObject.Find("BGFreeCoinsContent").transform.FindChild("WatchVideoButton/WatchVideoButton/NumberCoins").GetComponent<Text>().text = "100";
				if(GlobalVariables.GameplayMode == 1)
				{
					if(!LevelGenerator.timeVideoWatched)
						GameObject.Find("PopUps").transform.Find("PopUpGoal/AnimationHolder/Body/WatchVideoHolder").gameObject.SetActive(true);
				}
...
//				GameObject.Find("BGFreeCoinsContent").transform.FindChild("WatchVideoButton/WatchVideoButton/NumberCoins").GetComponent<Text>().text = "NO VIDEO AVAILABLE";
			if(Application.loadedLevelName.Equals("MainScene"))
			{
				GameObject.Find("Canvas").transform.Find("Menus/WorldChooserMenu/WorldChooseHolder/AnimationHolder/ModeHolder/DeselectedHolder/ChefDeselected/ChefBlue/Available/ButtonSpeedUp").gameObject.SetActive(false);
			}
			else if(Application.loadedLevelName.Equals("GamePlay"))
			{
				if(GlobalVariables.GameplayMode == 1)
				{
					GameObject.Find("PopUps").transform.Find("PopUpGoal/AnimationHolder/Body/WatchVideoHolder").gameObject.SetActive(false);
				}
				else if(GlobalVariables.GameplayMode == 0)
				{
